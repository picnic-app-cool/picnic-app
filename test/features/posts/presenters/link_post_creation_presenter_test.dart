...
void main() {
  ...
  late MockLinkPostCreationNavigator navigator;
  ...
  setUp(() {
    model = LinkPostCreationPresentationModel.initial(LinkPostCreationInitialParams(onTapPost: (_) {}));
    navigator = MockLinkPostCreationNavigator();
