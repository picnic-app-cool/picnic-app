...
void main() {
  late LinkDiscordAccountUseCase useCase;

  setUp(() {
    registerFallbackValue(const LinkSocialAccountRequest.empty());
    useCase = LinkDiscordAccountUseCase(
  ...
  test(
    ...
    () async {
      // GIVEN
      when(() => Mocks.socialAccountsRepository.linkDiscordAccount(any()))
          .thenAnswer((_) => successFuture(const LinkedDiscordAccount.empty()));
  ...
  test("getIt resolves successfully", () async {
    final useCase = getIt<LinkDiscordAccountUseCase>();
