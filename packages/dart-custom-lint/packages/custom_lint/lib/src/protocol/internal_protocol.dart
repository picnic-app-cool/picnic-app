...
class ExpectLintMeta {
  ...
  Map<String, Object?> toJson() {
    return {'line': line, 'code': code, 'location': location.asLocation().toJson()};
  }
}
...
class CustomAnalysisNotification {
  ...
  /// Encodes the object.
  Map<String, Object> toJson() => {...lints.toJson(), 'expect_lints': expectLints.map((e) => e.toJson()).toList()};
...
class SetConfigResult implements ResponseResult {
  ...
  factory SetConfigResult.fromResponse(Response response) => const SetConfigResult();
