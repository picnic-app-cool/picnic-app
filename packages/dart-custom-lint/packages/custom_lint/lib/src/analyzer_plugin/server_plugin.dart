...
import 'package:analyzer_plugin/src/protocol/protocol_internal.dart' show ResponseResult;
...
abstract class ServerPlugin {
  ...
  ///
  /// Throw a [RequestFailure] if the request could not be handled.
  FutureOr<EditGetAvailableRefactoringsResult> handleEditGetAvailableRefactorings(
