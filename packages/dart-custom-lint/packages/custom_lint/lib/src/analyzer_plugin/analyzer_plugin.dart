...
import 'package:analyzer_plugin/src/protocol/protocol_internal.dart' as plugin show RequestParams;
...
class CustomLintPlugin extends ServerPlugin {
  ...
  @override
  String get contactInfo => 'https://github.com/invertase/dart_custom_lint/issues';
  ...
  late final ProviderSubscription<Future<Map<PluginKey, Result<PluginLink>>>> _allPluginsSub;
  @override
  void start(PluginCommunicationChannel channel) {
    ...
    _container.listen<Map<String, plugin.AnalysisErrorsParams>>(allLintsProvider, (previous, next) {
  ...
  Future<plugin.AnalysisSetContextRootsResult> handleAnalysisSetContextRoots(
    ...
    _container.read(activeContextRootsProvider.notifier).state = parameters.roots;
  ...
  Future<plugin.EditGetFixesResult> handleEditGetFixes(
    ...
    return plugin.EditGetFixesResult(
      ...
      responses.map(plugin.EditGetFixesResult.fromResponse).expand((e) => e.fixes).toList(),
    );
  }
  ...
  @override
  FutureOr<plugin.AnalysisHandleWatchEventsResult> handleAnalysisHandleWatchEvents(
  ...
  @override
  FutureOr<plugin.AnalysisSetPriorityFilesResult> handleAnalysisSetPriorityFiles(
  ...
  @override
  FutureOr<plugin.AnalysisSetSubscriptionsResult> handleAnalysisSetSubscriptions(
  ...
  FutureOr<plugin.AnalysisUpdateContentResult> handleAnalysisUpdateContent(
    ...
    parameters.files.forEach((filePath, overlay) {
      ...
      if (overlay is plugin.AddContentOverlay) {
        ...
        try {
          newContents = plugin.SourceEdit.applySequence(oldContents, overlay.edits);
    ...
    for (final link in links.entries) {
      ...
      final files = Map.fromEntries(
        parameters.files.keys
          ...
          final message = content == null ? plugin.RemoveContentOverlay() : plugin.AddContentOverlay(content);
  ...
  @override
  FutureOr<plugin.CompletionGetSuggestionsResult> handleCompletionGetSuggestions(
  ...
  @override
  FutureOr<plugin.EditGetAvailableRefactoringsResult> handleEditGetAvailableRefactorings(
