...
class AnalyzerPluginCustomLintDelegate with LogCustomLintDelegate implements CustomLintDelegate {}

/// Maps events to the console
class CommandCustomLintDelegate with LogCustomLintDelegate implements CustomLintDelegate {
  @override
  void pluginMessage(
    ServerPlugin serverPlugin,
    PluginDetails pluginDetails,
