...
export 'src/public_protocol.dart'
    show Lint, LintLocation, LintSeverity, LineLocationUtils, LintLocationFileResultExtension;
...
void startPlugin(SendPort sendPort, PluginBase plugin) {
  ...
  runZonedGuarded(
    ...
    (err, stack) {
      send(
        PluginErrorParams(false, err.toString(), stack.toString()).toNotification().toJson(),
      );
    },
