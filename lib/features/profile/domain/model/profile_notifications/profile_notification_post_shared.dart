...
class ProfileNotificationPostShared extends Equatable implements ProfileNotification {
  const ProfileNotificationPostShared({
    required this.id,
  ...
  final Id userId;
  @override
  NotificationType get type => NotificationType.postShared;
