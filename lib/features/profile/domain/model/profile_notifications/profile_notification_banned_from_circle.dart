...
class ProfileNotificationBannedFromCircle extends Equatable implements ProfileNotification {
  const ProfileNotificationBannedFromCircle({
    required this.id,
  ...
  ProfileNotificationBannedFromCircle copyWith({
    Id? id,
    String? userAvatar,
    String? name,
    Id? userId,
