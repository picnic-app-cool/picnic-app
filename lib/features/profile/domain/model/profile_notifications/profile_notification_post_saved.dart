...
class ProfileNotificationPostSaved extends Equatable implements ProfileNotification {
  const ProfileNotificationPostSaved({
    required this.id,
  ...
  final Id userId;
  @override
  NotificationType get type => NotificationType.postSaved;
