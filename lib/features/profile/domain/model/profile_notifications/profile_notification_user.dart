...
class ProfileNotificationUser extends Equatable implements ProfileNotification {
  const ProfileNotificationUser({
    required this.id,
  ...
  final Id userId;
  @override
  NotificationType get type => NotificationType.user;
