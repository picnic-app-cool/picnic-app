...
class ProfileNotificationUnknown extends Equatable implements ProfileNotification {
  const ProfileNotificationUnknown({
    required this.id,
  ...
  final Id userId;
  @override
  NotificationType get type => NotificationType.unknown;
