...
import 'package:picnic_app/features/chat/circle_chat/widgets/circle_chat_row.dart';
...
class CircleChatMessagesList extends StatelessWidget {
  const CircleChatMessagesList({
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        if (isUserBanned) const UserBannedIndicator(),
      ],
    );
  }
