...
///[CircleChatRow] is the row in a chat body that holds the avatar and text
///
class CircleChatRow extends StatelessWidget {
  const CircleChatRow({
  ...
  bool get _isAuthorModerator => displayableMessage.chatMessage.isAuthorModerator;
  ...
  Widget build(BuildContext context) {
    final picnicMessage = ChatMessageContentClickable(
      ...
      isAuthorModerator: _isAuthorModerator,
    );
