...
class CommentReportView extends StatelessWidget {
  ...
  final CommentReport reportedComment;
  ...
  Widget build(BuildContext context) {
    ...
    final isResolved = reportedComment.status == ResolveStatus.resolved;
    ...
    return PicnicListItem(
      height: null,
      onTap: () => onTap(reportedComment),
      title: reportedComment.spammer.username.formattedUsername,
      ...
      subTitle: appLocalizations.reportedLabelFormat(reportedComment.reporter.username.formattedUsername),
      subTitleSpan: appLocalizations.reportedComment,
      ...
      leading: ReportAvatar(
        ...
        circleImage: reportedComment.spammer.profileImageUrl.url,
        isResolved: reportedComment.status == ResolveStatus.resolved,
      ),
    );
  }
