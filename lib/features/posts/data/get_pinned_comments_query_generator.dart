...
class GetPinnedCommentsQueryGenerator {
  const GetPinnedCommentsQueryGenerator();
...
query (\$postId: String!, $cursorVariablesArgumentList) {
  getPinnedComments(postId: \$postId) {
        ...CommentFields
      $repliesConnection
  }
}
