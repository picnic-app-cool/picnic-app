...
class EditSliceRulesPage extends StatefulWidget with HasPresenter<EditSliceRulesPresenter> {
  const EditSliceRulesPage({
    required this.presenter,
    Key? key,
  }) : super(key: key);

  @override
  final EditSliceRulesPresenter presenter;

  @override
  State<EditSliceRulesPage> createState() => _EditSliceRulesPageState();
}

class _EditSliceRulesPageState extends State<EditSliceRulesPage>
    with PresenterStateMixin<EditSliceRulesViewModel, EditSliceRulesPresenter, EditSliceRulesPage> {
