...
class LanguageSelectFormNavigator with NoRoutes {
  LanguageSelectFormNavigator(this.appNavigator);

  @override
  final AppNavigator appNavigator;
}

mixin LanguageSelectFormRoute {
  Future<void> openLanguageSelectForm(LanguageSelectFormInitialParams initialParams) async {
    return appNavigator.push(
      SlidingPageTransition(getIt<LanguageSelectFormPage>(param1: initialParams)),
      context: context,
    );
  }
