//ignore_for_file:omit_local_variable_types,require_trailing_commas,prefer-correct-identifier-length,comment_references
import "dart:convert";
...
Map<String, dynamic> generateFileFormBody(Map<String, dio.MultipartFile> fileMap) {
  ...
  final List<MapEntry<String, dio.MultipartFile>> fileMapEntries = fileMap.entries.toList(growable: false);
