...
abstract class SeedsRepository {
  ...
  Future<Either<GetElectionFailure, Governance>> getGovernance({required Id circleId});
  ...
  Future<Either<VoteDirectorFailure, Id>> voteDirector({required Id circleId, required Id userId});
